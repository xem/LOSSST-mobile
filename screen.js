...
draw_screen = () => {
  ...
  if(W == 0){
    p = 0;
    H = "<div class=m><h1 style='transform:scaleX(1.2)scaleY(2.2)'>LOSSST</h1><p><a onclick='cont();fadeout()'><h2 style='margin-top:30px'>"+(save[1][1]?"Continue":"PLAY")+"</h2></a><p><a style='font-size:50px' onclick=W=-1;fadeout()>Select puzzle</a><!--p><a onclick=W=-2;fadeout()>Bonus</a--><p class='emoji hide'>🌼";
    s.innerHTML = H;
  }
